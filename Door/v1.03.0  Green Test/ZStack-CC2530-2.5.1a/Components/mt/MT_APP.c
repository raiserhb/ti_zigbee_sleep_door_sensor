...
#ifdef MT_APP_GET_NETWORK_FUNC
extern void MT_znpSmartLifeGetNetwork(uint8 *pBuf);
#endif
#ifdef MT_APP_FACTORY_RESET_FUNC
extern void MT_znpSmartLifeFactoryReset(uint8 *pBuf);
#endif
#endif
...
uint8 MT_AppCommandProcessing(uint8 *pBuf)
{
  ...
  switch (pBuf[MT_RPC_POS_CMD1])
  {
    ...
    case MT_APP_USER_TEST:
      ...
      break;
#ifdef MT_APP_GET_NETWORK_FUNC
    case MT_APP_GET_NETWORK:
      MT_znpSmartLifeGetNetwork(pBuf);
      break;
#endif
#ifdef MT_APP_FACTORY_RESET_FUNC
    case MT_APP_FACTORY_RESET:
      MT_znpSmartLifeFactoryReset(pBuf);
      break;
#endif
    default:
