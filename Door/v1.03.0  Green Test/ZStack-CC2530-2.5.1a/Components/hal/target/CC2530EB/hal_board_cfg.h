...
#if !defined (OSC32K_CRYSTAL_INSTALLED) || (defined (OSC32K_CRYSTAL_INSTALLED) && (OSC32K_CRYSTAL_INSTALLED == FALSE))
...
/* ----------- LED's ---------- */
  ...
  #define HAL_TURN_OFF_LED2()       st( LED2_SBIT = LED2_POLARITY (1); )//st( LED2_SBIT = LED2_POLARITY (0); )
  ...
  #define HAL_TOGGLE_LED2()          st( if (LED1_SBIT) { LED1_SBIT = 0; } else { LED1_SBIT = 1;} )//st( if (LED2_SBIT) { LED2_SBIT = 0; } else { LED2_SBIT = 1;} )
  #define HAL_TOGGLE_LED3()         st( if (LED3_SBIT) { LED3_SBIT = 0; } else { LED3_SBIT = 1;} )
  #define HAL_TOGGLE_LED4()         HAL_TOGGLE_LED1()

  #define HAL_STATE_LED1()          (LED1_POLARITY (LED1_SBIT))
  #define HAL_STATE_LED2()          (LED1_POLARITY (LED1_SBIT))//(LED2_POLARITY (LED2_SBIT))
